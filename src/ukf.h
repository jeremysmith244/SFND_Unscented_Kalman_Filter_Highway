...
class UKF {
 public:
  ...
  Eigen::MatrixXd H_; // meaasurement projection vector
  Eigen::MatrixXd Ht_; // transpose of H
  Eigen::MatrixXd I_; // identity matrix
  Eigen::MatrixXd R_laser_; // Laser noise matrix
  Eigen::MatrixXd R_radar_; // Radar noise matrix
  ...
  double previous_timestamp_; // Previous time stamp
  double nis_;
};
